---
name: 'create-gh-readme'
description: 'Create a comprehensive README.md file for the project (based on https://docs.github.com/en/copilot/tutorials/customization-library/prompt-files/create-readme)'
---
...
- Links to non-existent documentation or files.
